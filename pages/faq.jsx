...
const QA = [
  ...
  },
  {
    ...
    answer: (
      <p>
        ...
        {' '}
        to specjalny proces optymalizacyjny, który ma za zadanie podnieść Twoją stronę w wynikach
        wyszukiwania. Jest to o tyle ważne, że w ten sposób możesz wyprzedzić swoją konkurencję i
        być łatwiej, szybciej i skuteczniej dostrzegalny. Jak każde działanie w internecie, tak i to
        rządzi się pewnymi regułami, których należy przestrzegać. Zbyt duże nacechowanie tekstu
        słowami kluczowymi, niedopasowane frazy czy brak jakichkolwiek wyrażeń będzie skutkować
        nieskutecznym SEO. Analogicznie - nienaturalnie brzmiące frazy lub zbyt częste występowanie
        tychże słów sprawi, że czytelnik zwyczajnie w świecie zmęczy się tekstem i opuści stronę.
        Tworząc każdy tekst, dbam o zachowanie optimum SEO i rozsądne wplatanie wyrażeń, dzięki
        czemu artykuł będzie przyjazny dla czytelnika i wartościowy dla algorytmów.
      </p>
    ),
  },
  {
    ...
    answer: (
      <p>
        Najczęściej tworzę teksty w Wordzie 2016, jednak w wyjątkowych przypadkach pracuję na
        szyfrowanym dokumencie Google. Jeśli Twój system operacyjny nie obsługuje pakietu Microsoft
        Office, zapiszę dla Ciebie tekst w PDF lub stworzę go w docs Google. Jeśli powyższe
        rozwiązania nie są dla Ciebie odpowiednie, wydrukuję gotowy tekst zgodnie ze
        {' '}
        <a
          href="https://pl.wikipedia.org/wiki/Znormalizowany_maszynopis"
          target="_blank"
          className="text-dark"
          rel="noreferrer"
        >
  ...
  },
  {
    ...
    answer: (
      <>
        ...
        <ol>
          <li>
            Kontaktujesz się ze mną telefonicznie lub mailowo i wykonujemy wywiad potrzeb. Zgłaszasz
            swoje oczekiwania i życzenia, a ja uzupełniam je o swoje pytania i doprecyzowania.
          </li>
          <li>
            Na podstawie pozyskanych informacji tworzę dla Ciebie ofertę, która szczegółowo omawia
            wykonanie zlecenia, określa stawkę oraz termin wykonania usługi. Przy większych
            zamówieniach lub długofalowej współpracy przedstawiam również umowę współpracy B2B in
            blanco, którą w następnym kroku podpisujemy.
          </li>
          <li>
          ...
          <li>
            ...
            oczekiwaniami, przechodzimy do rozliczenia, jeżeli pewne elementy Ci nie odpowiadają lub
            chcesz poprawić, nanoszę bezpłatną korektę zgodną z Twoimi wytycznymi.
          </li>
          <li>
            Wystawiam fakturę na wskazane dane, która płatna jest w ciągu 5 dni roboczych. Po
            opłaceniu faktury przekazuję Ci stosowne prawa autorskie, które są niezbędne do
            publikacji tekstu.
          </li>
        </ol>
      </>
  ...
  },
  {
    ...
    answer: (
      <p>
        Nie. Tworzenie prac służących do uzyskania tytułu naukowego jest w Polsce nielegalne i
        podlega sankcjom z tytułu
        {' '}
        <a
        ...
        {' '}
        Jeśli jednak masz problem z napisaniem takiego tekstu lub nie wiesz, jak taka praca powinna
        wyglądać, skorzystaj z pakietu konsultacji content marketing. Chętnie też sprawdzę Twoją
        pracę pod względem stylistycznym, gramatycznym oraz ortograficznym w ramach usługi korekty
        tekstów naukowych.
      </p>
    ),
  },
  {
    ...
    answer: (
      <p>
        Jeśli planujesz długoterminową współpracę lub rozpoczynasz projekt, który wymaga
        zaangażowania copywritera do zespołu, proponuję współpracę na
        {' '}
        <a
        ...
        {' '}
        . Po określeniu Twoich potrzeb i zrewidowaniu moich mocy przerobowych przedstawiam Ci
        dokument w wersji in blanco, który finalnie podpiszemy, by stanowił podstawę naszego
        współdziałania.
      </p>
    ),
  },
  ...
  },
  {
    ...
    answer: (
      <>
        <p>
          Stały cennik nie ma sensu w przypadku copywritingu, ponieważ każde zlecenie ma swój
          indywidualny stopień trudności i realizuje odmienne założenia. Inna stawka będzie
          wyliczona za wykonanie 100 opisów produktów do e-sklepu z elektronarzędziami, inna za wpis
          na bloga o naturalnych kosmetykach, a inna za przygotowanie raportu eksploatacyjnego
          maszyny tokarskiej. Na ostateczną cenę mają wpływ takie zmienne, jak:
        </p>
        <ul>
  ...
  {
    question:
      'Tekst, który dla mnie napisałeś, nie jest już dostępny. Gdzie dostanę kopię swojego tekstu?',
    answer:
      ...
      <Row className="my-5">
        <Col>
          <p className="text-justify">
            ...
            zastanawiasz się nad pewnymi aspektami współpracy. Poniżej zamieszczam odpowiedzi na
            najczęściej zadawane pytania w kwestii copywritingu, tworzonych przeze mnie tekstów i
            innych tematów pokrewnych. Jeśli nie znajdziesz odpowiedzi na swoje pytanie, napisz do
            mnie maila lub zadzwoń - jestem do Twojej dyspozycji.
          </p>
        </Col>
      </Row>
